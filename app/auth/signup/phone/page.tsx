...
export default function PhoneSignupPage() {
  ...
  const { dialCode: initialDialCode, national: initialNational } = parseStoredPhone(formData.phone)
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <p className="text-xs text-muted-foreground text-center">
          ...
          <a href="/auth/signin" className="text-secondary hover:underline font-medium">
            Sign in
          </a>
        </p>
      </form>
