    ...
    <main className="min-h-screen bg-gradient-to-b from-background to-muted flex flex-col items-center justify-center p-4">
      <div className="max-w-2xl space-y-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4 text-sm">
          <LocaleLink href="/analytics" className="text-primary hover:underline">
            {t('home.performanceAnalytics')}
          </LocaleLink>
          <span className="text-muted-foreground">•</span>
          <LocaleLink href="/load-test" className="text-primary hover:underline">
            {t('home.loadTesting')}
          </LocaleLink>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-16">
          <div className="p-6 bg-card rounded-lg border border-border">
            ...
            <h3 className="font-semibold text-foreground mb-2">{t('home.comprehensive')}</h3>
          ...
          <div className="p-6 bg-card rounded-lg border border-border">
            <div className="text-3xl mb-2">⚡</div>
            <h3 className="font-semibold text-foreground mb-2">{t('home.fastReliable')}</h3>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="p-6 bg-card rounded-lg border border-border">
            <div className="text-3xl mb-2">🔒</div>
            <h3 className="font-semibold text-foreground mb-2">{t('home.secure')}</h3>
            <p className="text-sm text-muted-foreground">
              {t('home.secureDesc')}
            </p>
          </div>
